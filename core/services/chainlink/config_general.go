...
func NewGeneralConfig(configToml string, secretsToml string) (coreconfig.GeneralConfig, error) {
	var c Config
	...
	return &generalConfig{c: &c, inputTOML: input, effectiveTOML: effective, secrets: &s, secretsInputTOML: secretsInput}, nil
}
